...
image:"SRC/assets/smartbuild.png",
category:"design"
},
{
id:5,
...
onClick={() => openModal(`src/assets/flyer${i+1}.jpg`)}
>
<img src={`src/assets/flyer${i+1}.jpg`} alt={`Flyer ${i+1}`} />
</motion.div>
))}
</div>
<div className="flyers-row">
...
whileHover={{scale:1.05}}
onClick={() => openModal(`src/assets/flyer${i+6}.jpg`)}
>
<img src={`src/assets/flyer${i+6}.jpg`} alt={`Flyer ${i+6}`} />
</motion.div>
))}
</div>
</div>
